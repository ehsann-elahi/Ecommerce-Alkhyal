	...
	<div class="container py-lg-3">
		...
		<div class="row w3-services-grids mt-lg-5">
			<div class="col-12 w3-services-left-grid">
				<h5>Privacy Policy for Alkhyal Android Application</h5>
				<p><strong>Effective Date:</strong> 27 Mar. 2025</p>
				<p>Alkhyal ("we", "our", or "us") is committed to protecting your privacy. This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you use our Alkhyal Android application ("the App"). Please read this policy carefully to understand our views and practices regarding your personal data.</p>
				...
				<ul>
					...
					<li>Request the deletion of your data by contacting us at <a href="mailto:support@alkhyal.ae">support@alkhyal.ae</a>.</li>
				</ul>
				...
				<ul>
					<li>Email: <a href="mailto:support@alkhyal.ae">support@alkhyal.ae</a></li>
				...
				<p>Welcome to Alkhyal! By using our Android application ("the App"), you agree to the following Terms and Conditions. Please read them carefully.</p>
				...
				<h6>2. Services</h6>
				<p>Alkhyal provides laundry pickup, cleaning, and delivery services via the App.</p>
				...
				<h6>9. Contact</h6>
				<p>For questions regarding these Terms, please contact us at <a href="mailto:support@alkhyal.ae">support@alkhyal.ae</a>.</p>

				<hr>
				<h5 class="mt-5">Alkhyal - Privacy Notice</h5>
				<p>We respect your privacy. Alkhyal collects your name, contact details, address, and order information to provide laundry pickup and delivery services.</p>
				<p>We:</p>
				<ul>
				...
				<p>By using Alkhyal, you agree to our full Privacy Policy available here or in the App settings.</p>
				<p>For questions, contact us at <a href="mailto:support@alkhyal.ae">support@alkhyal.ae</a>.</p>
			</div>
		</div>
	</div>
</div>
