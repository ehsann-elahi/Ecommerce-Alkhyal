                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <input class="form-control" type="text" name="title" value="{{ $product->title }}" placeholder="Enter Meta Title">
                                </div>
                                <div class="form-group mb-3">
                                    <label>Meta Description</label>
                                    <input class="form-control" type="text" name="meta_description" value="{{ $product->meta_description }}" placeholder="Enter Meta Description">
                                </div>
                                 <div class="form-group mb-3">
                                    <label>Slug Product</label>
                                    <input class="form-control" type="text" name="slug" value="{{ $product->slug }}" placeholder="Enter Meta Title">
                                </div>
                                <div class="form-group mb-3 px-0">
                                    <label>Price</label>
                                ...
                                <div class="form-group mb-3 px-0">
                                    ...
                                    <select class="form-control form-control-rounded" name="type">
                                        ...
                                        <option value="Featured" {{ $product->type == 'Featured' ? 'selected' : '' }}>Featured</option>
                                ...
                                <div class="row">
                                    <div class="col-8">
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-8 text-center">
                                                <img id="adminimg3" src="{{ asset('assets/upload/prod/' . $product->img) }}" alt="Product Image" width="100">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                    ...
                                    <div class="col-4">
                                        <div class="form-group">
                                            <label class="control-label" for="profile_photo">Product Gallery Images</label>
                                            <div class="col">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3 text-center">
                                        <img loading="lazy" src="{{ asset('assets/upload/gallery/' . $gallery->photo) }}" alt="Gallery Image" width="100">
                                        <input type="checkbox" name="delete_gallery[]" value="{{ $gallery->id }}"> Delete
                                    </div>
                                    @endforeach
                                </div>
                            </div>
                            ...
                            <button type="submit" class="col-3 ml-3 btn btn-primary btn-block btn-rounded mt-3" style="float: inline-end;">Update</button>
                        </div>
                    </form>
                </div>
            </div>
